...
Only if a candidate has cleared his/her examinations in current year and original marksheets for such examinations is not issued by concerned university/institutions, then only other evidences of passing examination and grades/marks obtained will be acceptable; however, in such cases original marksheet must be submitted for verification within one month of joining, otherwise, their admission will be cancelled even after joining</h4></li>';
...
echo '<li><h4>Authority letter (as per format given at [main menu] -> [Instructions] -> [General] ) is required, if applicant can not come personally for giving application and varification of original documents.</h4></li>';
